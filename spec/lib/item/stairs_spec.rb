...
describe Item::Stairs do
  ...
  describe ".sprite_value" do
    it { expect(item.sprite_value).to eq 3 }
  end

  describe ".interact" do
    it "raises the player's health by 1" do
      expect{ item.interact(player) }.to change{ player.health }.to(0)
    end
  end
end
